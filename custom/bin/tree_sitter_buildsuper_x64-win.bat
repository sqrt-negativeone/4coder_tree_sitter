...
REM usage: <script> [target [mode [extra_libs]]]
...
set tree_sitter_root=%custom_root%\..\code\tree_sitter\
cd %location%
...
call cl %opts% "%target%" /Fe%binname% %build_dll% %extra_libs%
